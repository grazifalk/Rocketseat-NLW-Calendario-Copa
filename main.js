...
document.querySelector('#cards').innerHTML =
  createCard('20/11', 'sexta', createGame('qatar', '13:00', 'ecuador')) +
...
//   blue.classList.toggle("body.blue");
// }

// function themeYellow() {
//   var yellow = document.body;
//   yellow.classList.toggle("body.root");
// }

// function themeGreen() {
//   var green = document.body;
//   green.classList.toggle("body.green");
// }